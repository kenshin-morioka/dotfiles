...
-- <C-r><C-o>+ はレジスタ内容をリテラル挿入する (<C-r>+ だと autoindent / autopairs の影響を受ける)
vim.keymap.set("v", "p", '"_c<C-r><C-o>+<Esc>') -- クリップボードを保持したままペースト
vim.keymap.set("s", "p", '<C-g>"_c<C-r><C-o>+<Esc>') -- セレクトモード：ビジュアルに切り替えてからペースト
